              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: const Color.fromARGB(255, 219, 219, 219)), //цвет за картинкой 
                  ),
                ),
                Padding(
                  ...
                  trailing: IconButton(icon: Icon(Icons.keyboard_arrow_right, size: 30, color: Colors.red,),onPressed: (){ //кнопка перехода на новость
